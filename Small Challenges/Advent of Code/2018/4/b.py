...
if __name__ == "__main__":
    ...
    # Guard with the most minutes asleep at their node
    max_sleep = max([guard.time_span[guard.find_mode_minute()] for guard in guards])
    for guard in guards:
        if guard.time_span[guard.find_mode_minute()] == max_sleep:
